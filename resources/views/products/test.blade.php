...
@section('content')
        ...
        <div class="row">
            ...
            <div class="swiper-wrapper d-flex border-animation-left">
                ...
                <div class="banner-item image-zoom-effect">
                    ...
                    <a href="#">
                        <img src="{{ asset('template/images/banner-image-6.jpg') }}" alt="product" class="img-fluid">
                    </a>
                    </div>
                ...
                <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                    <a href="#">
                        <img src="{{ asset('template/images/banner-image-1.jpg') }}" alt="product" class="img-fluid">
                    </a>
                    </div>
                    <div class="banner-content py-4">
                    <h5 class="element-title text-uppercase">
                ...
                <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                    <a href="#">
                        <img src="{{ asset('template/images/banner-image-2.jpg') }}" alt="product" class="img-fluid">
                    </a>
                    </div>
                    <div class="banner-content py-4">
                    <h5 class="element-title text-uppercase">
                ...
                <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                    <a href="#">
                        <img src="{{ asset('template/images/banner-image-3.jpg') }}" alt="product" class="img-fluid">
                    </a>
                    </div>
                    <div class="banner-content py-4">
                    <h5 class="element-title text-uppercase">
                ...
                <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                    <a href="#">
                        <img src="{{ asset('template/images/banner-image-4.jpg') }}" alt="product" class="img-fluid">
                    </a>
                    </div>
                    <div class="banner-content py-4">
                    <h5 class="element-title text-uppercase">
                ...
                <div class="banner-item image-zoom-effect">
                    <div class="image-holder">
                    <a href="#">
                        <img src="{{ asset('template/images/banner-image-5.jpg') }}" alt="product" class="img-fluid">
                    </a>
                    </div>
                    <div class="banner-content py-4">
                    <h5 class="element-title text-uppercase">
    ...
    <section class="categories overflow-hidden">
        ...
        <div class="open-up" data-aos="zoom-out">
            ...
            <div class="col-md-4">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/cat-item1.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/cat-item2.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                </div>
                <div class="category-content">
                    <div class="product-button">
            ...
            <div class="col-md-4">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/cat-item3.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                </div>
                <div class="category-content">
                    <div class="product-button">
        ...
        <div class="swiper product-swiper open-up" data-aos="zoom-out">
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder position-relative">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-1.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder position-relative">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-2.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder position-relative">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-3.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder position-relative">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-4.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder position-relative">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-10.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
    ...
    <section id="best-sellers" class="best-sellers product-carousel py-5 position-relative overflow-hidden">
        ...
        <div class="swiper product-swiper open-up" data-aos="zoom-out">
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-3.jpg') }}" alt="product" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-5.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-6.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-9.jpg') }}" alt="categories" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
    ...
    <section class="video py-5 overflow-hidden">
        ...
        <div class="row">
            ...
            <div class="video-player">
                ...
                <img src="{{ asset('template/images/text-pattern.png') }}" alt="pattern" class="text-rotate">
                </a>
            </div>
            </div>
        </div>
    ...
    <section id="related-products" class="related-products product-carousel py-5 position-relative overflow-hidden">
        ...
        <div class="swiper product-swiper open-up" data-aos="zoom-out">
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-5.jpg') }}" alt="product" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-6.jpg') }}" alt="product" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-7.jpg') }}" alt="product" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
            ...
            <div class="swiper-slide">
                ...
                <div class="image-holder">
                    <a href="index.html">
                    <img src="{{ asset('template/images/product-item-8.jpg') }}" alt="product" class="product-image img-fluid">
                    </a>
                    <a href="index.html" class="btn-icon btn-wishlist">
                    <svg width="24" height="24" viewBox="0 0 24 24">
                        <use xlink:href="#heart"></use>
    ...
    <section class="blog py-5">
        ...
        <div class="row">
            ...
            <article class="post-item">
                ...
                <a href="index.html">
                    <img src="{{ asset('template/images/post-image1.jpg') }}" alt="image" class="post-grid-image img-fluid">
                </a>
                </div>
            ...
            <article class="post-item">
                <div class="post-image">
                <a href="index.html">
                    <img src="{{ asset('template/images/post-image2.jpg') }}" alt="image" class="post-grid-image img-fluid">
                </a>
                </div>
                <div class="post-content d-flex flex-wrap gap-2 my-3">
                <div class="post-meta text-uppercase fs-6 text-secondary">
            ...
            <article class="post-item">
                <div class="post-image">
                <a href="index.html">
                    <img src="{{ asset('template/images/post-image3.jpg') }}" alt="image" class="post-grid-image img-fluid">
                </a>
                </div>
                <div class="post-content d-flex flex-wrap gap-2 my-3">
                <div class="post-meta text-uppercase fs-6 text-secondary">
    ...
    <section class="logo-bar py-5 my-5">
        ...
        <div class="row">
            ...
            <img src="{{ asset('template/images/logo1.png') }}" alt="logo" class="logo-image img-fluid">
            <img src="{{ asset('template/images/logo2.png') }}" alt="logo" class="logo-image img-fluid">
            <img src="{{ asset('template/images/logo3.png') }}" alt="logo" class="logo-image img-fluid">
            <img src="{{ asset('template/images/logo4.png') }}" alt="logo" class="logo-image img-fluid">
            <img src="{{ asset('template/images/logo5.png') }}" alt="logo" class="logo-image img-fluid">
            </div>
        </div>
        </div>
    </section>
