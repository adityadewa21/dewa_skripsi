    ...
    <footer id="footer" class="mt-5">
        ...
        <div class="container">
            ...
            <div class="col-md-6 d-flex flex-wrap">
                ...
                <img src="{{ asset('template/images/arct-icon.png') }}" alt="icon">
                <img src="{{ asset('template/images/dhl-logo.png') }}" alt="icon">
                </div>
                <div class="payment-option">
                <span>Payment Option:</span>
                <img src="{{ asset('template/images/visa-card.png') }}" alt="card">
                <img src="{{ asset('template/images/paypal-card.png') }}" alt="card">
                <img src="{{ asset('template/images/master-card.png') }}" alt="card">
                </div>
            </div>
            <div class="col-md-6 text-end">
                <p>© Copyright {{ date('d-m-Y') }} Puti Azmi. All rights reserved. Design by</p>
            </div>
            </div>
        </div>
        </div>
