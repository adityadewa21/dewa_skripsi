...
<html lang="en">
    ...
    <head>
        <title>@yield('title', 'Dewa Shop')</title>
        <meta charset="utf-8">
        ...
        <ul class="cat-list">
            @forelse ($navCategories as $category)
                <li class="cat-list-item">
                    <a href="{{ route('products.category', $category->slug) }}"title="{{ $category->name }}">
                        {{ $category->name }}
                    </a>
                </li>
            @empty
                <li class="px-3 text-muted">No categories</li>
            @endforelse
        </ul>
                ...
                <div class="col-auto">
                    <a class="navbar-brand text-white" href="{{ route('index') }}">
                        <svg width="200" height="45">
                            <text x="0" y="32" fill="#111" font-size="28" font-weight="700">
                                Dewa Shop
                            </text>
                        </svg>
                    </a>
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar">
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav flex-grow-1 gap-2">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('order.track') }}">Tracking Order</a>
                                </li>
                ...
                <div class="col-3 col-lg-auto">
                    <ul class="list-unstyled d-flex m-0 align-items-center">
                        ...
                        <li class="d-none d-lg-block">
                            @guest
                                <a href="{{ route('login') }}" class="text-uppercase mx-3">Login</a>
                            @endguest

                            @auth
                                <div class="dropdown d-inline">
                                    <a href="#" class="text-uppercase mx-3 dropdown-toggle"
    ...
    <footer id="footer" class="mt-5">
        ...
        <div class="row d-flex flex-wrap justify-content-between py-5">
            ...
            <div class="footer-menu footer-menu-002">
                ...
                <li class="menu-item">
                    <a href="{{ route('index') }}" class="item-anchor">Home</a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('products.all') }}" class="item-anchor">Product</a>
                </li>
                <li class="menu-item">
            ...
            <div class="footer-menu footer-menu-004 border-animation-left">
                ...
                <p>Punya pertanyaan? Hubungi kami <a href="mailto:contact@yourcompany.com"
                    class="item-anchor">dewashop@gmail.com</a></p>
        ...
        <div class="container">
            ...
            <div class="col-md-6 text-end">
                <p>© Copyright {{ date('Y') }} Dewa Shop. All rights reserved.</p>
            </div>
            </div>
        </div>
        </div>
